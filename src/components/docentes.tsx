          ...
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-center py-4">
              ...
              <nav className="hidden md:flex space-x-6">
                <Link to="/" className="text-gray-700 font-medium hover:text-maroon-700 transition">Início</Link>
                <Link to="/sobre" className="text-gray-700 font-medium hover:text-maroon-700 transition">Sobre</Link>
                <Link to="/docentes" className="text-maroon-700 font-medium hover:text-maroon-900 transition">Docentes</Link>
